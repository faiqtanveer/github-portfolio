      ...
      children: [
        Row(
          children: [
            ...
            IconButton(onPressed: () {launchUrl(Uri.parse(projectList[index].githubLink));}, icon: SvgPicture.asset('assets/icons/github.svg')),
          ],
        ),
        const Spacer(),
        TextButton(
            onPressed: () {
              launchUrl(Uri.parse(projectList[index].githubLink));
